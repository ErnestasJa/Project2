...
const glm::tvec3<uint8_t> cubecoords[8] = // verts of bounding cube
{
	glm::tvec3<uint8_t>(8, 8, 0),
	glm::tvec3<uint8_t>(0, 8, 0),
	glm::tvec3<uint8_t>(0, 8, 8),
	glm::tvec3<uint8_t>(8, 8, 8),
	glm::tvec3<uint8_t>(8, 0, 8),
	glm::tvec3<uint8_t>(0, 0, 8),
	glm::tvec3<uint8_t>(0, 0, 0),
	glm::tvec3<uint8_t>(8, 0, 0),
};
